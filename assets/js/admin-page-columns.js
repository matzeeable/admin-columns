...
/* harmony import */ var _admin_columns_remove_columns__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./admin/columns/remove-columns */ "./js/admin/columns/remove-columns.ts");
...
let AcServices = Object(_helpers_admin_columns__WEBPACK_IMPORTED_MODULE_2__["initAcServices"])();
...
AcServices.addListener(_constants__WEBPACK_IMPORTED_MODULE_1__["EventConstants"].SETTINGS.FORM.READY, (form) => {
    let removeColumns = new _admin_columns_remove_columns__WEBPACK_IMPORTED_MODULE_12__["default"](AcServices);
...
/*!**********************************!*\
  !*** ./js/admin/columns/ajax.ts ***!
  \**********************************/
/*! exports provided: submitColumnSettings, switchColumnType, refreshColumn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class Form {
    ...
    bindColumnEvents(column) {
        ...
        column.events.addListener(_column__WEBPACK_IMPORTED_MODULE_1__["COLUMN_EVENTS"].CLONE, () => {
            let cloneColumn = new _column__WEBPACK_IMPORTED_MODULE_1__["Column"](column.getElement().cloneNode(true), Object(_helpers_string__WEBPACK_IMPORTED_MODULE_5__["uniqid"])(), this.services);
...
const createColumnFromTemplate = (services) => {
    ...
    const newColumnName = Object(_helpers_string__WEBPACK_IMPORTED_MODULE_5__["uniqid"])();
...
/***/ "./js/admin/columns/remove-columns.ts":
/*!********************************************!*\
  !*** ./js/admin/columns/remove-columns.ts ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RemoveColumns; });
...
class RemoveColumns {
    constructor(services) {
        this.element = _helpers_html_element__WEBPACK_IMPORTED_MODULE_0__["default"].create('a').addClass('ac-clear-columns').addHtml(AC.i18n.clear_columns).element;
        this.services = services;
        this.init();
    }
    getElement() {
    ...
    init() {
        this.element.addEventListener('click', (e) => {
            ...
            if (this.services.hasService('Form')) {
                this.services.getService('Form').resetColumns();
            }
        });
    }
}
